...
public class ProjetDeFinDeFormationApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Event e1 = new Event(null, "Indochine", "Concert Indochine The Last Tourney 1", 30000, d.parse("10/12/2022"),
				"20h", "Concert", 55, null, u3, l1);
		Event e2 = new Event(null, "Caroline Martinez", "Caro fait son One Woman Show", 6300, d.parse("19/02/2023"),
				"20h30", "Humour", 15, null, u5, l2);
		Event e3 = new Event(null, "", "France-Brésil", 50000, d.parse("23/12/2022"), "20h", "Football Masculin", 70,
				null, u3, l1);
		Event e4 = new Event(null, "Ahadi Mahaboubi", "Tous à Nancy pour Nöel", 100, d.parse("25/12/2022"), "20h",
				"Apéritif Dinatoire", 10, null, u3, l4);
